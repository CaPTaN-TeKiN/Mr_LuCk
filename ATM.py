#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To TEKIN_MOHAMMAD
...
logo = """
       \033[1;96m:▒▒▒▒███▒███▒███▒███▒▒▒▒▒▒▒▒▒▒:\033[1;95m♡
      \033[1;96m▒▒▒▒▒▒▒▒█▒█▒█▒▒▒█▒█▒█▒▒▒▒▒▒▒▒▒▒::\033[1;94m♡TeKin☠️
     \033[1;96m:▒▒▒▒▒▒███▒█▒█▒███▒█▒█▒▒▒▒▒▒▒▒▒▒:::\033[1;93m♡A-T_M    
    \033[1;96m::▒▒▒▒▒▒█▒▒▒█▒█▒█▒▒▒█▒█▒▒▒▒▒▒▒▒▒▒::::\033[1;92m♡      
   \033[1;96m:::▒▒▒▒▒▒███▒███▒███▒███▒▒▒▒▒▒▒▒▒▒:::::\033[1;91m♡         
  \033[1;96m::▒▒▒▒▒▒\033[1;91mWhatsapp\033[1;96m▒▒▒▒▒▒▒▒▒▒▒▒▒::::\033[1;96m♡        
  \033[1;96m:▒▒▒▒▒▒\033[1;93m+9324161457\033[1;96m▒▒▒▒▒▒▒▒▒▒▒:::::\033[1;92m♡
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-TM.creations-\033[1;95m♡╭────•◈•───╮♡
\033[1;92m....................TM.creations......................
╔══╗╔══╗╔══╗╔╗╔╗╔══╗╔═╦╗╔══╗╔══╗╔══╗╔══╗╔═╦╗  
║╔╗║║═╦╝║╔═╣║╚╝║║╔╗║║║║║╚║║╝║══╣╚╗╔╝║╔╗║║║║║  
║╠╣║║╔╝─║╚╗║║╔╗║║╠╣║║║║║╔║║╗╠══║─║║─║╠╣║║║║║  
╚╝╚╝╚╝──╚══╝╚╝╚╝╚╝╚╝╚╩═╝╚══╝╚══╝─╚╝─╚╝╚╝╚╩═╝  WE ARE BROTHERS
...
\033[1;95m
   ...
   \033[1;92m███████▒▒Welcome To Tekin.creations▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mA.Creations\033[1;95m♡╭───•◈•───╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mMr_LuCky_420
\033[1;94mA.ATM\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mTiKiN MuTlu
\033[1;94mWTelgrame\033[1;91m: \033[1;91m@Mr_LuCky_420
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mA.CREATIONS\033[1;95m♡╰───•◈•───╯♡"""
jalan('    \033[1;96m............Mr_LuCky_420...............:')
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:ATM_hacker
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:ATM_hacker
	print logo
...
def pilih_super():
	...
	print "\033[1;95m♡───────•◈•──────♡\033[1;96mTM.creations\033[1;95m♡──────•◈•────♡"
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mA.creations\033[1;95m♡───•◈•───────♡"
	print "  \033[1;93m«---•◈•---Developed By TEKIN ---•◈•---»" #Dev:TIKN_ATM
	...
	print """
            ...
            ╚════════════════╝
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Mr_LuCky_420............ \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                telgrame 
              facebooklearn"""
